...
{
    if(!_ballImage){
        _ballImage = [[UIImageView alloc]initWithFrame:RECT(32*KWIDTH,33*KWIDTH,36*KWIDTH,36*KWIDTH)];
...
-(UILabel *)ballName{
    if(!_ballName){
        ...
        _ballName.frame = CGRectMake(89*KWIDTH,38*KWIDTH,100*KWIDTH,23*KWIDTH);
        _ballName.font  = Font12;
        _ballName.textAlignment = NSTextAlignmentLeft;
