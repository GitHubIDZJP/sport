...
#import "nextView.h"
@interface HXBasketballViewController ()<UINavigationControllerDelegate,UITableViewDataSource,UITableViewDelegate>
{
    nextView *view;
    currentView *view1;
...
@implementation HXBasketballViewController
