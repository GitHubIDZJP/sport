...
//http://www.cnstorm.com/index.php?route=api/tool/config
 [[zjpNetWork manager]POST:@"https://sports.hxweixin.top/api/v1/fbinfo/infoNav" parameters:parameter success:^(id responseBody) {
           ...
           if([responseBody[@"code"] intValue] == 200){
               ...
               NSString *str =self->apiGlobalArr[3][@"country_array"][0][@"country_name"][0];
                         NSLog(@"数组-1-%@",str);
                NSString *str1 =self->apiGlobalArr[3][@"country_array"][1][@"country_name"][0];
...
//               NSString *firstRow = self->apiGlobalArr[3][@"country_array"][0][@"union_array"][0][@"union_name"][0];
//                            _bosses = @[firstRow];
//               NSString *vie =self->apiGlobalArr[3][@"country_array"][1][@"union_array"][0][@"union_name"][0];
//                NSString *vie1 =self->apiGlobalArr[3][@"country_array"][1][@"union_array"][1][@"union_name"][0];
//               _bamboo =@[vie,vie1];
               
               _bosses =self->apiGlobalArr[3][@"country_array"][0][@"union_array"];
               _bamboo = self->apiGlobalArr[3][@"country_array"][1][@"union_array"];
