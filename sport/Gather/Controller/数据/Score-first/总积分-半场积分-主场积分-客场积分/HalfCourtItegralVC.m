...
@interface HalfCourtItegralVC ()<UITableViewDelegate,UITableViewDataSource>
@property (strong,nonatomic)UITableView *tableView;
@property (nonatomic,copy)NSArray *teamName;
@property (nonatomic,copy) NSArray *buttonTitles;
@end

@implementation HalfCourtItegralVC
-(NSArray *)teamName
{
    if(!_teamName){
        ...
        _teamName = @[@"0利物浦",@"莱斯特城",@"曼城",@"切尔西",@"曼联",@"热刺",@"狼队",@"谢菲尔德联",@"水晶宫",@"利物浦",@"11",@"12",@"13",@"14"];
    }
    return _teamName;
