...
@interface fansViewController ()<UINavigationControllerDelegate,UITableViewDelegate,UITableViewDataSource>
    ...
    for(int b = 0;b< buttonLabels.count;b++){
        ...
        if(b == 0){
            ...
            [_selBtn viewRadius:2 RectCorner:UIRectCornerBottomRight | UIRectCornerTopRight view:_selBtn];
                   ...
                   //#4CB13B
                       [_selBtn  borderForColor:colorWithHexString(@"#4CB13B") borderWidth:lineSpece borderType:UIBorderSideTypeLeft];
           ...
           _selBtn.layer.borderColor=color(65,142,69).CGColor;
            ...
            [_selBtn borderForColor:colorWithHexString(@"#4CB13B") borderWidth:0.1 borderType:UIBorderSideTypeRight];
        }else if (b == 1){
        //#4CB13B
             [_selBtn viewRadius:2 RectCorner:UIRectCornerBottomRight | UIRectCornerTopRight view:_selBtn];
            _selBtn.backgroundColor = colorWithHexString(@"#4CB13B");
                       [_selBtn setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
            [_selBtn borderForColor:colorWithHexString(@"#4CB13B") borderWidth:0.1 borderType:UIBorderSideTypeLeft];
    ...
    selecIndex = sender.tag;
      if (sender.tag == 100 || selecIndex == 100) {
         // btn2.layer.borderWidth = 1;
          btn2.layer.borderColor = color( 65,142,69).CGColor;//不选中
          ...
          [btn2 borderForColor:colorWithHexString(@"#4CB13B") borderWidth:lineSpece borderType:UIBorderSideTypeLeft];
                  ...
                  [btn2 borderForColor:colorWithHexString(@"#4CB13B") borderWidth:0.5 borderType:UIBorderSideTypeRight];
