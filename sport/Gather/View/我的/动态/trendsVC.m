...
#import "trendsVC.h"
#import "trendsCell.h"
@interface trendsVC ()<UITableViewDataSource,UITableViewDelegate>
...
-(UITableView *)tableView{
    ...
    if(!_tableView){
        ...
        _tableView.rowHeight = 352*KWIDTH;
        IOS11;
    }
    return _tableView;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    trendsCell *cell=[tableView dequeueReusableCellWithIdentifier:ID];
    if(cell == nil)
    {
        //  cell=[[XibCustomCellT alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
        //注册一个XIBcell
        cell=[[[NSBundle mainBundle]loadNibNamed:@"trendsCell" owner:nil options:nil]lastObject];
        
    }
     [self addBorderToLayer:cell.ballPic];
